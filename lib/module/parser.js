...
var convertRule = function(fieldName, rule, messages) {
  ...
  if (options) {
    if (isArray(options)) {
      params = convertArray.call(this, fieldName, options, messages);
...
var convertArray = function(fieldName, options, messages) {
  ...
  return _.map(subRules, function(subRule) {
    return convertRule.call(this, fieldName, subRule, messages);
  }, this);
};
